...
const UsersInfo = () => {
    ...
    return(
        <div className="bh_scanresult_wrapper">
            <Header title={"Scan QR Code"} button={"1"} path={"/admin/scan"}/>
            <div className="bh_scanresult_body">
                <div className="bh_scanresult_top">
                  <div className="bh_scanresult_image">
                    <img src={scanned} />
                  </div>
                  <p className="bh_scanresult_completed">Scan Completed!</p>
                  <p className="bh_scanresult_type">Type: Booth check-in</p>
                </div>
                <div className="bh_scanresult_content">
                    <div className="bh_scanresult_title">
                        <p>User Info Updated</p>
                    </div>
                    <div className="bh_scanresult_list">
